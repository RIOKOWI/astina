...
import '../../providers/me_household_provider.dart';
import '../../data/models/household_model.dart';

class MyHouseholdPage extends ConsumerStatefulWidget {
  const MyHouseholdPage({super.key});

  @override
  ConsumerState<MyHouseholdPage> createState() => _MyHouseholdPageState();
}

class _MyHouseholdPageState extends ConsumerState<MyHouseholdPage> {
  @override
  Widget build(BuildContext context) {
    final householdAsync = ref.watch(meHouseholdProvider);
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ref.invalidate(meHouseholdProvider);
        },
        child: householdAsync.when(
          data: (household) {
            if (household == null) return _buildNoHousehold();
  ...
  Widget _buildHouseholdContent(HouseholdModel household) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          ...household.members.map<Widget>((m) => _buildMemberCard(m)),
        ],
      ),
    );
  }

  Widget _buildAddressCard(HouseholdModel household) {
    return Container(
